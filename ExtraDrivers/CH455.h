...
extern void CH455_Show_uint(uint16_t num); // 显示一个无符号整数
extern void CH455_Show_float(float num);   // 显示一位整数三位小数
extern uint8_t CH455_Read_KeyID(void); // 读取按键代码
